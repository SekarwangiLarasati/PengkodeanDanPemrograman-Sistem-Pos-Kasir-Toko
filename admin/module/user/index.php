...
?>
<h4>Profil Pemilik Akun</h4>
<br>
<?php if(isset($_GET['success'])){?>
<div class="alert alert-success">
	<p>Edit Data Anda Telah Berhasil !</p>
</div>
<?php }?>
<?php if(isset($_GET['remove'])){?>
<div class="alert alert-danger">
	<p>Hapus Data Anda Telah Berhasil !</p>
</div>
<?php }?>
<div class="row">
	<div class="col-sm-3">
		<div class="card card-primary">
			<div class="card-header">
				<h5 class="mt-2"><i class="fa fa-user"></i> Foto Pemilik </h5>
			</div>
			<div class="card-body">
			...
			<div class="card-footer">
				<form method="POST" action="fungsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
					...
					<button type="submit" class="btn btn-primary btn-md" value="Tambah">
						<i class="fas fa-edit mr-1"></i>  Ganti Foto Terbaru
					</button>
				</form>
			</div>
		</div>
	...
	<div class="col-sm-5">
		<div class="card card-primary">
			<div class="card-header">
				<h5 class="mt-2"><i class="fa fa-user"></i> Biodata Pemilik </h5>
			</div>
			<div class="card-body">
				<div class="box-content">
					<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?profil=edit"
						...
						<fieldset>
							...
							<div class="control-group mb-3">
								<label class="control-label" for="typeahead">Email Tedaftar </label>
								<div class="input-group">
							...
							<div class="control-group mb-3">
								...
								<div class="input-group">
									<input type="text" class="form-control" style="border-radius:0px;" name="nik"
										value="<?php echo $hasil['NIM']; ?>" required="required" />
								</div>
							</div>
							<div class="control-group mb-3">
							...
							<div class="control-group mb-3">
								...
								<div class="controls">
									<textarea name="alamat" rows="3" class="form-control" style="border-radius:0px;"
										required="required"><?php echo $hasil['alamat_pemilik']; ?></textarea>
								</div>
							</div>
							<div class="control-group mb-3">
								<label class="control-label" for="typeahead">Alamat Toko </label>
								<div class="controls">
									<textarea name="alamat" rows="3" class="form-control" style="border-radius:0px;"
							...
							<button class="btn btn-primary" name="btn" value="Tambah">
								<i class="fas fa-edit"></i> Mengubah Biodata
							</button>
						</fieldset>
					</form>
				</div>
